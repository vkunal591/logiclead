    ...
    <div className="overflow-hidden">
      ...
      >
        <div className="flex justify-between items-center lg:text-white/70 hover:text-gray-500">
          <h2 className="text-lg lg:text-sm font-medium lg:font-none">
            {title}
          </h2>
      ...
      >
        <div
          className={`py-2 ${diffColor ? "" : "bg-gray-900"} space-y-3 mt-2`}
        >
          {content.map((link: any) => (
            <li
              key={link.href}
              className="text-[15px] lg:text-xs pl-4 lg:pl-2 list-disc"
            >
              <Link
