...
const ProviderSection = () => {
    return (
        <section className="p-4 lg:p-8 max-w-7xl mx-auto bg-white">
            <div className="max-w-7xl mx-auto px-4">
                <h3 className="text-2xl text-center font-semibold mb-6">FASTag Provider</h3>

                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    {providers.map((provider, idx) => (
                        <div
                            key={idx}
                            className="bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center p-4 text-center"
                        >
                            ...
                            <p className="text-sm font-medium text-center truncate line-clamp-1 w-4/5">{provider.name}</p>
                        </div>
                    ))}
                </div>
            </div>
